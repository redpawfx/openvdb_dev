...
IF (APPLE)
  ...
  FIND_LIBRARY ( TBB_LIBRARY_PATH tbb PATHS ${TBB_LOCATION}/lib/libc++ )
  FIND_LIBRARY ( TBB_PREVIEW_LIBRARY_PATH tbb_preview PATHS ${TBB_LOCATION}/lib/libc++ )
  FIND_LIBRARY ( TBBMALLOC_LIBRARY_PATH tbbmalloc PATHS ${TBB_LOCATION}/lib/libc++ )
